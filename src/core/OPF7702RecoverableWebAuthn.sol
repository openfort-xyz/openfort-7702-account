 ...
 */
contract OPF7702RecoverableWebAuthn is OPF7702, EIP712 layout at 57943590311362240630886240343495690972153947532773266946162183175043753177960 {
        ...
        unchecked {
            for (uint256 i; i < _signatures.length; ++i) {
                ...
                if (sigType == KeyType.EOA) {
                    ...
                    if (
                        !IWebAuthnVerifier(WEBAUTHN_VERIFIER).verifySoladySignature(
                            challenge,
                            requireUV,
                            authenticatorData,
                            clientDataJSON,
