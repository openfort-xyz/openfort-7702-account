...
contract InitProxy is Script, IKey {
    ...
    function run() public {
        ...
        ISpendLimit.SpendTokenInfo memory spendInfoSK = ISpendLimit.SpendTokenInfo({ token: TOKEN, limit: 1000e18 });
        ...
        bytes32 structHash = keccak256(
            abi.encode(
                RECOVER_TYPEHASH, keyMK.pubKey.x, keyMK.pubKey.y, keyMK.eoaAddress, keyMK.keyType, initialGuardian
            )
        );
