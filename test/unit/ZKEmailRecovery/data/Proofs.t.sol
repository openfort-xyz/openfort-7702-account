...
abstract contract Proofs is Etch {
    ...
    string public path;
    string public json_proofs =
        vm.readFile("test/unit/ZKEmailRecovery/data/proofs/ProofsDataGeneral.json");
    string public json_proofs_key_eoa =
        vm.readFile("test/unit/ZKEmailRecovery/data/proofs/ProofsDataKeyEOA.json");
