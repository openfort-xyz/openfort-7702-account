...
import {OPF7702RecoverableWebAuthn as OPF7702} from "src/core/OPF7702RecoverableWebAuthn.sol";
...
contract RecoverableWebAuthn is Base {
    /* ───────────────────────────────────────────────────────────── contracts ── */
    ...
    function _initializeAccount() internal {
        ...
        vm.prank(address(entryPoint));
        account.initialize(keyMK, spendInfo, _allowedSelectors(), msgHash, sig, keyGuardianEOA);
    }
}
