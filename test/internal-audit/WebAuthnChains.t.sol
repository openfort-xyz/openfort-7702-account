...
contract WebAuthnChains is Test {
    ...
    function setUp() public {
        ...
        BNB_RPC = "https://bsc-mainnet.public.blastapi.io";
        GNO_RPC = "https://rpc.gnosischain.com";
    ...
    function test_ARB() public {
        forkId = vm.createFork(ARBITRUM_RPC);
    ...
    function test_ARB_Solady() public {
        forkId = vm.createFork(ARBITRUM_RPC);
        vm.selectFork(forkId);
