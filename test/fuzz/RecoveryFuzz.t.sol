...
contract RecoveryFuzz is Deploy {
    ...
    function _collectGuardianSignatures(uint32 required) internal returns (bytes[] memory sigs) {
    ...
    function _buildEOARecoveryKey(address newOwner) internal view returns (IKey.KeyDataReg memory) {
